...
class InvoiceItemsTest < MiniTest::Test 
  ...
  def invoice_item_attributes
      {id: "1", item_id: "1", invoice_id: "1", quantity: "5", unit_price: "13635", created_at: "2012-03-27 14:54:09 UTC", updated_at: "2012-03-27 14:54:09 UTC"}
  end
  ...
  def test_item_id
    assert_equal "1", invoice_items.item_id
  end
  ...
  def test_each_invoice_item_returns_an_invoice
    assert_kind_of Invoice, invoice_items.invoice
  end

  def test_each_item_returns_an_item
    assert_kind_of Item, invoice_items.item
  end
